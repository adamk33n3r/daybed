package com.adam_keenan.mcmods.daybed.items;

import com.adam_keenan.mcmods.daybed.DayBed;
...
public class DaybedItem extends ItemBed {
    public DaybedItem() {
        this.setCreativeTab(new CreativeTabs(CreativeTabs.getNextID(), "DayBed") {
    ...
    public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_, int p_77648_5_, int p_77648_6_, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_)
    {
        ...
        {
            ++p_77648_5_;
            DaybedBlock blockbed = (DaybedBlock)DayBed.bedBlock;
